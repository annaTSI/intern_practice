...
select avg(Salary),min(Salary),Max(Salary)from employees where  Hire_date="2022-01-01" and "2022-12-31"
...
SELECT 
    ...
    (next_order_date - current_order_date) AS gap_days
FROM 
    OrderSequences
WHERE 
    (next_order_date - current_order_date) > 30;
